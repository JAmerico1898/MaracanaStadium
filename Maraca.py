...
if button:
    ...
    if estimativa_publico <= 40000:
      ...
      breakeven_publico = (despesa_fixa + 729000)/(0.95*ticket_medio - 2)
...
### AGORA O TICKET     
    ...
    if 20000*ticket_medio >= (despesa_fixa + 0.05*20000*ticket_medio + 2*20000 +400000):
        ...
        rendaliquida_45k = int(0.96*(45000*ticket_medio - (despesa_fixa + 0.05*45000*ticket_medio + 2*45000 +729000)))
        rendaliquida_50k = int(0.96*(50000*ticket_medio - (despesa_fixa + 0.05*50000*ticket_medio + 2*50000 +729000)))
        rendaliquida_55k = int(0.96*(55000*ticket_medio - (despesa_fixa + 0.05*55000*ticket_medio + 2*55000 +729000)))
        rendaliquida_60k = int(0.96*(60000*ticket_medio - (despesa_fixa + 0.05*60000*ticket_medio + 2*60000 +729000)))
        rendaliquida_65k = int(0.96*(65000*ticket_medio - (despesa_fixa + 0.05*65000*ticket_medio + 2*65000 +729000)))
        ...
        rendaliquida_45k = 0.96*(45000*ticket_medio - (despesa_fixa + 0.05*45000*ticket_medio + 2*45000 +729000))
        rendaliquida_50k = 0.96*(50000*ticket_medio - (despesa_fixa + 0.05*50000*ticket_medio + 2*50000 +729000))
        rendaliquida_55k = 0.96*(55000*ticket_medio - (despesa_fixa + 0.05*55000*ticket_medio + 2*55000 +729000))
        rendaliquida_60k = 0.96*(60000*ticket_medio - (despesa_fixa + 0.05*60000*ticket_medio + 2*60000 +729000))
        rendaliquida_65k = 0.96*(65000*ticket_medio - (despesa_fixa + 0.05*65000*ticket_medio + 2*65000 +729000))
        rendaliquida_values = (rendaliquida_20k, rendaliquida_25k, rendaliquida_30k, rendaliquida_35k, rendaliquida_40k, 
                                   rendaliquida_45k, rendaliquida_50k, rendaliquida_55k, rendaliquida_60k, rendaliquida_65k)
    ...
    elif 40000*ticket_medio < (despesa_fixa + 0.05*40000*ticket_medio + 2*40000 +400000) and 45000*ticket_medio >= (despesa_fixa + 0.05*45000*ticket_medio + 2*45000 +729000):
        rendabruta_values = (20000*ticket_medio, 25000*ticket_medio, 30000*ticket_medio, 35000*ticket_medio, 40000*ticket_medio, 
                             45000*ticket_medio, 50000*ticket_medio, 55000*ticket_medio, 60000*ticket_medio, 65000*ticket_medio)
        rendaliquida_20k = (20000*ticket_medio - (despesa_fixa + 0.05*20000*ticket_medio + 2*20000 +400000))
        rendaliquida_25k = (25000*ticket_medio - (despesa_fixa + 0.05*25000*ticket_medio + 2*25000 +400000))
    ...
    elif 45000*ticket_medio < (despesa_fixa + 0.05*45000*ticket_medio + 2*45000 +729000) and 50000*ticket_medio >= (despesa_fixa + 0.05*50000*ticket_medio + 2*50000 +729000):
        rendabruta_values = (20000*ticket_medio, 25000*ticket_medio, 30000*ticket_medio, 35000*ticket_medio, 40000*ticket_medio, 
                             45000*ticket_medio, 50000*ticket_medio, 55000*ticket_medio, 60000*ticket_medio, 65000*ticket_medio)
        rendaliquida_20k = (20000*ticket_medio - (despesa_fixa + 0.05*20000*ticket_medio + 2*20000 +400000))
        rendaliquida_25k = (25000*ticket_medio - (despesa_fixa + 0.05*25000*ticket_medio + 2*25000 +400000))
        ...
        rendaliquida_35k = (35000*ticket_medio - (despesa_fixa + 0.05*35000*ticket_medio + 2*35000 +400000))
        rendaliquida_40k = (40000*ticket_medio - (despesa_fixa + 0.05*40000*ticket_medio + 2*40000 +400000))
        rendaliquida_45k = (45000*ticket_medio - (despesa_fixa + 0.05*45000*ticket_medio + 2*45000 +729000))
        rendaliquida_50k = int(0.96*(50000*ticket_medio - (despesa_fixa + 0.05*50000*ticket_medio + 2*50000 +729000)))
        rendaliquida_55k = int(0.96*(55000*ticket_medio - (despesa_fixa + 0.05*55000*ticket_medio + 2*55000 +729000)))
        rendaliquida_60k = int(0.96*(60000*ticket_medio - (despesa_fixa + 0.05*60000*ticket_medio + 2*60000 +729000)))
        rendaliquida_65k = int(0.96*(65000*ticket_medio - (despesa_fixa + 0.05*65000*ticket_medio + 2*65000 +729000)))
    ...
    elif 50000*ticket_medio < (despesa_fixa + 0.05*50000*ticket_medio + 2*50000 +729000) and 55000*ticket_medio >= (despesa_fixa + 0.05*55000*ticket_medio + 2*55000 +729000):
        rendabruta_values = (20000*ticket_medio, 25000*ticket_medio, 30000*ticket_medio, 35000*ticket_medio, 40000*ticket_medio, 
                             45000*ticket_medio, 50000*ticket_medio, 55000*ticket_medio, 60000*ticket_medio, 65000*ticket_medio)
        rendaliquida_20k = (20000*ticket_medio - (despesa_fixa + 0.05*20000*ticket_medio + 2*20000 +400000))
        rendaliquida_25k = (25000*ticket_medio - (despesa_fixa + 0.05*25000*ticket_medio + 2*25000 +400000))
        ...
        rendaliquida_40k = (40000*ticket_medio - (despesa_fixa + 0.05*40000*ticket_medio + 2*40000 +400000))
        rendaliquida_45k = (45000*ticket_medio - (despesa_fixa + 0.05*45000*ticket_medio + 2*45000 +729000))
        rendaliquida_50k = (50000*ticket_medio - (despesa_fixa + 0.05*50000*ticket_medio + 2*50000 +729000))
        rendaliquida_55k = int(0.96*(55000*ticket_medio - (despesa_fixa + 0.05*55000*ticket_medio + 2*55000 +729000)))
        rendaliquida_60k = int(0.96*(60000*ticket_medio - (despesa_fixa + 0.05*60000*ticket_medio + 2*60000 +729000)))
        rendaliquida_65k = int(0.96*(65000*ticket_medio - (despesa_fixa + 0.05*65000*ticket_medio + 2*65000 +729000)))
        rendaliquida_values = (rendaliquida_20k, rendaliquida_25k, rendaliquida_30k, rendaliquida_35k, rendaliquida_40k, 
    ...
    elif 55000*ticket_medio < (despesa_fixa + 0.05*55000*ticket_medio + 2*55000 +729000) and 60000*ticket_medio >= (despesa_fixa + 0.05*60000*ticket_medio + 2*60000 +729000):
        rendabruta_values = (20000*ticket_medio, 25000*ticket_medio, 30000*ticket_medio, 35000*ticket_medio, 40000*ticket_medio, 
                             45000*ticket_medio, 50000*ticket_medio, 55000*ticket_medio, 60000*ticket_medio, 65000*ticket_medio)
        rendaliquida_20k = (20000*ticket_medio - (despesa_fixa + 0.05*20000*ticket_medio + 2*20000 +400000))
        rendaliquida_25k = (25000*ticket_medio - (despesa_fixa + 0.05*25000*ticket_medio + 2*25000 +400000))
        ...
        rendaliquida_45k = (45000*ticket_medio - (despesa_fixa + 0.05*45000*ticket_medio + 2*45000 +729000))
        rendaliquida_50k = (50000*ticket_medio - (despesa_fixa + 0.05*50000*ticket_medio + 2*50000 +729000))
        rendaliquida_55k = (55000*ticket_medio - (despesa_fixa + 0.05*55000*ticket_medio + 2*55000 +729000))
        rendaliquida_60k = int(0.96*(60000*ticket_medio - (despesa_fixa + 0.05*60000*ticket_medio + 2*60000 +729000)))
        rendaliquida_65k = int(0.96*(65000*ticket_medio - (despesa_fixa + 0.05*65000*ticket_medio + 2*65000 +729000)))
        rendaliquida_values = (rendaliquida_20k, rendaliquida_25k, rendaliquida_30k, rendaliquida_35k, rendaliquida_40k, 
                                   rendaliquida_45k, rendaliquida_50k, rendaliquida_55k, rendaliquida_60k, rendaliquida_65k)

    elif 60000*ticket_medio < (despesa_fixa + 0.05*60000*ticket_medio + 2*60000 +729000) and 65000*ticket_medio >= (despesa_fixa + 0.05*65000*ticket_medio + 2*65000 +729000):
        rendabruta_values = (20000*ticket_medio, 25000*ticket_medio, 30000*ticket_medio, 35000*ticket_medio, 40000*ticket_medio, 
                             45000*ticket_medio, 50000*ticket_medio, 55000*ticket_medio, 60000*ticket_medio, 65000*ticket_medio)
        rendaliquida_20k = (20000*ticket_medio - (despesa_fixa + 0.05*20000*ticket_medio + 2*20000 +400000))
        rendaliquida_25k = (25000*ticket_medio - (despesa_fixa + 0.05*25000*ticket_medio + 2*25000 +400000))
        ...
        rendaliquida_50k = (50000*ticket_medio - (despesa_fixa + 0.05*50000*ticket_medio + 2*50000 +729000))
        rendaliquida_55k = (55000*ticket_medio - (despesa_fixa + 0.05*55000*ticket_medio + 2*55000 +729000))
        rendaliquida_60k = (60000*ticket_medio - (despesa_fixa + 0.05*60000*ticket_medio + 2*60000 +729000))
        rendaliquida_65k = int(0.96*(65000*ticket_medio - (despesa_fixa + 0.05*65000*ticket_medio + 2*65000 +729000)))
        rendaliquida_values = (rendaliquida_20k, rendaliquida_25k, rendaliquida_30k, rendaliquida_35k, rendaliquida_40k, 
                                   rendaliquida_45k, rendaliquida_50k, rendaliquida_55k, rendaliquida_60k, rendaliquida_65k)
        ...
        rendaliquida_55k = (55000*ticket_medio - (despesa_fixa + 0.05*55000*ticket_medio + 2*55000 +729000))
        rendaliquida_60k = (60000*ticket_medio - (despesa_fixa + 0.05*60000*ticket_medio + 2*60000 +729000))
        rendaliquida_65k = (65000*ticket_medio - (despesa_fixa + 0.05*65000*ticket_medio + 2*65000 +729000))
        rendaliquida_values = (rendaliquida_20k, rendaliquida_25k, rendaliquida_30k, rendaliquida_35k, rendaliquida_40k, 
                                   rendaliquida_45k, rendaliquida_50k, rendaliquida_55k, rendaliquida_60k, rendaliquida_65k)
